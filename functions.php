...
add_action('wp_enqueue_scripts', 'iwisp_scripts', 100);
function iwisp_scripts(){
  wp_register_script(
    'bootstrap-script', 
...
*/
  ...
  wp_register_script(
    'iwisp-scripts', 
    get_template_directory_uri() . '/js/iwisp-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('iwisp-scripts');  
}

add_action('wp_enqueue_scripts', 'iwisp_styles');
function iwisp_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('iwisp', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('iwisp');
}
